...
static struct riscv_implicit_subset riscv_implicit_subsets[] =
{
  ...
  {"xtheadc", "xtheadint",		check_implicit_always},
  ...
  {"xtheade", "xtheadfmemidx",		check_implicit_always},
  ...
  {"xtheade", "xtheadmempair",		check_implicit_always},
  {"xtheade", "xtheadsync",		check_implicit_always},
  {"xtheadse", "xtheadba",		check_implicit_always},
  {"xtheadse", "xtheadbb",		check_implicit_always},
  {"xtheadse", "xtheadbs",		check_implicit_always},
  {"xtheadse", "xtheadcmo",		check_implicit_always},
  {"xtheadse", "xtheadcondmov",		check_implicit_always},
  {"xtheadse", "xtheadfmemidx",		check_implicit_always},
  {"xtheadse", "xtheadfmv",		check_implicit_always},
  {"xtheadse", "xtheadint",		check_implicit_always},
  {"xtheadse", "xtheadmac",		check_implicit_always},
  {"xtheadse", "xtheadmemidx",		check_implicit_always},
  {"xtheadse", "xtheadmempair",		check_implicit_always},
  {"xtheadse", "xtheadsync",		check_implicit_always},
  {NULL, NULL, NULL}
};
