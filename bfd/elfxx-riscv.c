...
static struct riscv_implicit_subset riscv_implicit_subsets[] =
{
  ...
  {"v", "+d,+zve64d,+zvl128b", check_implicit_always},
  ...
  {"zve32f", "+f,+zvl32b,+zve32x", check_implicit_always},
  ...
  {"zvkn", "+zvkned,+zvknha,+zvknhb,+zvkb,+zvkt", check_implicit_always},
...
static struct riscv_supported_ext riscv_supported_vendor_x_ext[] =
{
  ...
  XUANTIE_DEFINE_ALL_riscv_supported_vendor_x_ext
  { NULL, 0, 0, 0, 0 }
};
			     ...
			     enum riscv_insn_class insn_class)
{
  switch (insn_class)
    ...
    XUANTIE_DEFINE_ALL_riscv_multi_subset_supports

    default :
      rps->error_handler (_ ("internal: unreachable INSN_CLASS_*"));
      return false;
    }
}
				 ...
				 enum riscv_insn_class insn_class)
{
  switch (insn_class)
    ...
    XUANTIE_DEFINE_ALL_riscv_multi_subset_supports_ext
